...
handleTryClickingText(); //when window load this is what we will get
...
function generateRandomPressingOnKeyboardKeys(keys) {
  ...
  let wholeAnimationDuration = 6100; //magic number! dont get lazy and change it bruh change it to get the sum of all typing animation duration
...
function handleTryClickingText() {
  let wholeAnimationDurationSemi = 5600; //magic number! dont get lazy and change it bruh change it to get the sum of all typing animation duration
  setTimeout(() => {
    const hello = document.querySelector(".hello");
    const name = document.querySelector(".my-name");
    hello.style.display = "none";
  }, wholeAnimationDurationSemi - 50);
}
